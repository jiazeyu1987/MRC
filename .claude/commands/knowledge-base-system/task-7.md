# knowledge-base-system - Task 7

Execute task 7 for the knowledge-base-system specification.

## Task Description
Create KnowledgeBase service for business logic in backend/app/services/knowledge_base_service.py

## Code Reuse
**Leverage existing code**: backend/app/services/role
...
## Usage
```
/Task:7-knowledge-base-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create KnowledgeBase service for business logic in backend/app/services/knowledge_base_service.py"

```
Use the @spec-task-executor agent to implement task 7: "Create KnowledgeBase service for business logic in backend/app/services/knowledge_base_service.py" for the knowledge-base-system specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Create KnowledgeBase service for business logic in backend/app/services/knowledge_base_service.py
- Leverage: backend/app/services/role
- Requirements: 1.1, 2.1, 4.1

## Instructions
- Implement ONLY task 7: "Create KnowledgeBase service for business logic in backend/app/services/knowledge_base_service.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks knowledge-base-system 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks knowledge-base-system 7 --mode complete
```
