...
Execute task 13 for the knowledge-base-system specification.

## Task Description
Create knowledge base API client in front/src/api/knowledgeApi.ts

## Code Reuse
**Leverage existing code**: front/src/api/roleApi.ts for API client patterns and error handling
...
## Usage
```
/Task:13-knowledge-base-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create knowledge base API client in front/src/api/knowledgeApi.ts"

```
Use the @spec-task-executor agent to implement task 13: "Create knowledge base API client in front/src/api/knowledgeApi.ts" for the knowledge-base-system specification and include all the below context.
...
## Task Details
- Task ID: 13
- Description: Create knowledge base API client in front/src/api/knowledgeApi.ts
- Leverage: front/src/api/roleApi.ts for API client patterns and error handling
- Requirements: 1.1, 1.2, 2.1, 3.1

## Instructions
- Implement ONLY task 13: "Create knowledge base API client in front/src/api/knowledgeApi.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks knowledge-base-system 13 --mode complete
...
```bash
claude-code-spec-workflow get-tasks knowledge-base-system 13 --mode complete
```
