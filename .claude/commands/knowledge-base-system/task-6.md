# knowledge-base-system - Task 6

Execute task 6 for the knowledge-base-system specification.

## Task Description
Create RAGFlow service for external API integration in backend/app/services/ragflow_service.py

## Code Reuse
**Leverage existing code**: existing LLM integration patterns in backend/app/services/
...
## Usage
```
/Task:6-knowledge-base-system
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create RAGFlow service for external API integration in backend/app/services/ragflow_service.py"

```
Use the @spec-task-executor agent to implement task 6: "Create RAGFlow service for external API integration in backend/app/services/ragflow_service.py" for the knowledge-base-system specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Create RAGFlow service for external API integration in backend/app/services/ragflow_service.py
- Leverage: existing LLM integration patterns in backend/app/services/
- Requirements: 1.2, 3.2, 4.2

## Instructions
- Implement ONLY task 6: "Create RAGFlow service for external API integration in backend/app/services/ragflow_service.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks knowledge-base-system 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks knowledge-base-system 6 --mode complete
```
