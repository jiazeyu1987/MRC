# knowledge-base-ragflow-integration - Task 11.1

Execute task 11.1 for the knowledge-base-ragflow-integration specification.

## Task Description
Create migration documentation in doc/migration_guide.md
...
## Usage
```
/Task:11.1-knowledge-base-ragflow-integration
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create migration documentation in doc/migration_guide.md"

```
Use the @spec-task-executor agent to implement task 11.1: "Create migration documentation in doc/migration_guide.md" for the knowledge-base-ragflow-integration specification and include all the below context.
...
## Task Details
- Task ID: 11.1
- Description: Create migration documentation in doc/migration_guide.md
- Leverage: doc/ragflow.md
- Requirements: 4.7

## Instructions
- Implement ONLY task 11.1: "Create migration documentation in doc/migration_guide.md"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 11.1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 11.1 --mode complete
```
