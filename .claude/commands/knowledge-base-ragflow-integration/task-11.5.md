# knowledge-base-ragflow-integration - Task 11.5

Execute task 11.5 for the knowledge-base-ragflow-integration specification.
...
## Usage
```
/Task:11.5-knowledge-base-ragflow-integration
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add usage examples to feature documentation"

```
Use the @spec-task-executor agent to implement task 11.5: "Add usage examples to feature documentation" for the knowledge-base-ragflow-integration specification and include all the below context.
...
## Task Details
- Task ID: 11.5
- Description: Add usage examples to feature documentation
- Leverage: doc/ragflow.md
- Requirements: All

## Instructions
- Implement ONLY task 11.5: "Add usage examples to feature documentation"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 11.5 --mode complete
...
```bash
claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 11.5 --mode complete
```
