# knowledge-base-ragflow-integration - Task 7.2

Execute task 7.2 for the knowledge-base-ragflow-integration specification.

## Task Description
Create AdvancedSearch component in front/src/components/AdvancedSearch.tsx
...
## Usage
```
/Task:7.2-knowledge-base-ragflow-integration
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create AdvancedSearch component in front/src/components/AdvancedSearch.tsx"

```
Use the @spec-task-executor agent to implement task 7.2: "Create AdvancedSearch component in front/src/components/AdvancedSearch.tsx" for the knowledge-base-ragflow-integration specification and include all the below context.
...
## Task Details
- Task ID: 7.2
- Description: Create AdvancedSearch component in front/src/components/AdvancedSearch.tsx
- Leverage: front/src/components/TestConversation.tsx
- Requirements: 2.1, 2.4, 2.5

## Instructions
- Implement ONLY task 7.2: "Create AdvancedSearch component in front/src/components/AdvancedSearch.tsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 7.2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 7.2 --mode complete
```
