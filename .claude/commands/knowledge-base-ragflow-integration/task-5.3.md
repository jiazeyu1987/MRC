# knowledge-base-ragflow-integration - Task 5.3

Execute task 5.3 for the knowledge-base-ragflow-integration specification.

## Task Description
Add search API methods to front/src/api/knowledgeApi.ts
...
## Usage
```
/Task:5.3-knowledge-base-ragflow-integration
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add search API methods to front/src/api/knowledgeApi.ts"

```
Use the @spec-task-executor agent to implement task 5.3: "Add search API methods to front/src/api/knowledgeApi.ts" for the knowledge-base-ragflow-integration specification and include all the below context.
...
## Task Details
- Task ID: 5.3
- Description: Add search API methods to front/src/api/knowledgeApi.ts
- Leverage: front/src/api/knowledgeApi.ts
- Requirements: 2.1, 2.2, 2.6

## Instructions
- Implement ONLY task 5.3: "Add search API methods to front/src/api/knowledgeApi.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 5.3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 5.3 --mode complete
```
