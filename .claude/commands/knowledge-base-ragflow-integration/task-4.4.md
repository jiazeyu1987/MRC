# knowledge-base-ragflow-integration - Task 4.4

Execute task 4.4 for the knowledge-base-ragflow-integration specification.

## Task Description
Update main types index in front/src/types/index.ts
...
## Usage
```
/Task:4.4-knowledge-base-ragflow-integration
```

## Instructions

Execute with @spec-task-executor agent the following task: "Update main types index in front/src/types/index.ts"

```
Use the @spec-task-executor agent to implement task 4.4: "Update main types index in front/src/types/index.ts" for the knowledge-base-ragflow-integration specification and include all the below context.
...
## Task Details
- Task ID: 4.4
- Description: Update main types index in front/src/types/index.ts
- Leverage: front/src/types/knowledge.ts
- Requirements: All

## Instructions
- Implement ONLY task 4.4: "Update main types index in front/src/types/index.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 4.4 --mode complete
...
```bash
claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 4.4 --mode complete
```
