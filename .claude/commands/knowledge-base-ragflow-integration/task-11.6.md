# knowledge-base-ragflow-integration - Task 11.6

Execute task 11.6 for the knowledge-base-ragflow-integration specification.

## Task Description
Add development guidelines to feature documentation
...
## Usage
```
/Task:11.6-knowledge-base-ragflow-integration
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add development guidelines to feature documentation"

```
Use the @spec-task-executor agent to implement task 11.6: "Add development guidelines to feature documentation" for the knowledge-base-ragflow-integration specification and include all the below context.
...
## Task Details
- Task ID: 11.6
- Description: Add development guidelines to feature documentation
- Leverage: doc/ragflow.md
- Requirements: All

## Instructions
- Implement ONLY task 11.6: "Add development guidelines to feature documentation"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 11.6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 11.6 --mode complete
```
