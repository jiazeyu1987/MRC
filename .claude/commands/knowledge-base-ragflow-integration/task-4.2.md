# knowledge-base-ragflow-integration - Task 4.2

Execute task 4.2 for the knowledge-base-ragflow-integration specification.

## Task Description
Create search types in front/src/types/search.ts
...
## Usage
```
/Task:4.2-knowledge-base-ragflow-integration
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create search types in front/src/types/search.ts"

```
Use the @spec-task-executor agent to implement task 4.2: "Create search types in front/src/types/search.ts" for the knowledge-base-ragflow-integration specification and include all the below context.
...
## Task Details
- Task ID: 4.2
- Description: Create search types in front/src/types/search.ts
- Leverage: front/src/types/knowledge.ts
- Requirements: 2.1, 2.2, 2.6

## Instructions
- Implement ONLY task 4.2: "Create search types in front/src/types/search.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 4.2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 4.2 --mode complete
```
