# knowledge-base-ragflow-integration - Task 11.2

Execute task 11.2 for the knowledge-base-ragflow-integration specification.

## Task Description
Update README.md with new features

## Code Reuse
**Leverage existing code**: README.md, doc/ragflow.md
...
## Usage
```
/Task:11.2-knowledge-base-ragflow-integration
```

## Instructions

Execute with @spec-task-executor agent the following task: "Update README.md with new features"

```
Use the @spec-task-executor agent to implement task 11.2: "Update README.md with new features" for the knowledge-base-ragflow-integration specification and include all the below context.
...
- Leverage: README.md, doc/ragflow.md
- Requirements: All

## Instructions
- Implement ONLY task 11.2: "Update README.md with new features"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 11.2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 11.2 --mode complete
```
