# knowledge-base-ragflow-integration - Task 4.3

Execute task 4.3 for the knowledge-base-ragflow-integration specification.

## Task Description
Create API reference types in front/src/types/api-reference.ts

## Code Reuse
**Leverage existing code**: front/src/types/knowledge.ts
...
## Usage
```
/Task:4.3-knowledge-base-ragflow-integration
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create API reference types in front/src/types/api-reference.ts"

```
Use the @spec-task-executor agent to implement task 4.3: "Create API reference types in front/src/types/api-reference.ts" for the knowledge-base-ragflow-integration specification and include all the below context.
...
## Task Details
- Task ID: 4.3
- Description: Create API reference types in front/src/types/api-reference.ts
- Leverage: front/src/types/knowledge.ts
- Requirements: 3.1, 3.2, 3.5

## Instructions
- Implement ONLY task 4.3: "Create API reference types in front/src/types/api-reference.ts"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 4.3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 4.3 --mode complete
```
