# knowledge-base-ragflow-integration - Task 2.5

Execute task 2.5 for the knowledge-base-ragflow-integration specification.

## Task Description
Add service getter functions in backend/app/services/__init__.py

## Code Reuse
**Leverage existing code**: backend/app/services/
...
## Usage
```
/Task:2.5-knowledge-base-ragflow-integration
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add service getter functions in backend/app/services/__init__.py"

```
Use the @spec-task-executor agent to implement task 2.5: "Add service getter functions in backend/app/services/__init__.py" for the knowledge-base-ragflow-integration specification and include all the below context.
...
## Task Details
- Task ID: 2.5
- Description: Add service getter functions in backend/app/services/__init__.py
- Leverage: backend/app/services/
- Requirements: All

## Instructions
- Implement ONLY task 2.5: "Add service getter functions in backend/app/services/__init__.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 2.5 --mode complete
...
```bash
claude-code-spec-workflow get-tasks knowledge-base-ragflow-integration 2.5 --mode complete
```
